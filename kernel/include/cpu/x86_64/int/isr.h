 ...
 *
 * This function is invoked by the CPU when an interrupt occurs. It takes an interrupt frame as its
 * parameter, which contains information about the state of the CPU at the time of the interrupt.
